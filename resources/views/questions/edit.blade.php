...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow">
        <div class="p-6 border-b">
            <h1 class="text-2xl font-bold">Chỉnh sửa câu hỏi</h1>
            <p class="text-gray-600 mt-2">Cập nhật thông tin câu hỏi của bạn</p>
        </div>

        <form action="{{ route('questions.update', $question) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
...
- [link](url)"
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-500 text-sm">Chọn tối đa 5 tags. 
                    ...
                    @else
                        <span class="text-gray-400">(Cần 50 điểm để tạo tag mới)</span>
                    @endif
                </p>
            </div>
            ...
            <div class="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h4 class="font-semibold text-blue-900 mb-2">💡 Mẹo chỉnh sửa câu hỏi:</h4>
            ...
            <div class="flex items-center justify-between">
                <a href="{{ route('questions.show', $question) }}" class="text-gray-600 hover:text-gray-900">
                    ← Quay lại
                </a>
